...
namespace TicTacToe.Repositories
{
    ...
    public class PlayersRepository : IRepository<Player>
    {
        ...
        /// <summary>Gets all players DB records.</summary>
        /// <returns>List with all players DB records</returns>
        ...
        /// <param name="player">Specified player we want to add</param>
        public void Add(Player player) => _db.Players.Add(player);

        /// <summary>Updates the info about the specified player in DB.</summary>
        /// <param name="player">Specified player which info we want to update</param>
